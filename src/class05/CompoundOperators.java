...
/**
 * Compound operators are easy way to use  the current value of variable and add,
 * substruct, multiple, divide by a new value and reassign the resulting value into the original variable
 */
